...
| **개발 방식** | 1인 개발 |
| **개발 시작** | 2026년 초 |
| **현재 상태** | 고스트피스 토글 + 점수 공식 전면 교체 + 아이템 5종 재설계 완료, 게임오버 패널 미구현 |

---

## 현재 구현 현황 (2026-03-23 기준, 2차 업데이트)
...
- [x] **고스트피스 토글** — ON/OFF 영구 토글, OFF 시 점수 ×1.5 보너스
- [x] **아이템 5종 확정** — 중력 아이템 제거, 고스트피스를 토글 버튼으로 전환
- [ ] **점수 시스템 추가** — 게임 오버 시 최종 점수 결산 화면
